...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="site-wrap" id="home-section">
		...
		<p style="margin-left:1400px; margin-bottom: -18px; color:black;">
			${memberLoggedIn.memberID } 님 안녕하세요</p>
			
			<div class="container">
				<div class="row align-items-center position-relative">
					<div class="col-3 ">
						<div class="site-logo">
							<a href="${pageContext.request.contextPath }" class="font-weight-bold">Yujeong's</a>
						</div>
					</div>
					...
					<div class="col-9  text-right">
						...
						<nav class="site-navigation text-right ml-auto d-none d-lg-block"
							...
							<ul class="site-menu main-menu js-clone-nav ml-auto ">
								...
								<li><a href="post.html" class="nav-link">Visitor's Book</a></li>
								<c:if test="${memberLoggedIn == null }">
								<li><a href="${pageContext.request.contextPath }/account/login.do" class="nav-link">Login</a></li>
								</c:if>
								<c:if test="${memberLoggedIn != null }">
								<li><a href="${pageContext.request.contextPath }/account/logout.do" class="nav-link">Logout</a></li>
								</c:if>
							</ul>
						</nav>
					</div>
