...
<!-- account header 선언 -->
<%@ include file="/WEB-INF/views/account/header.jsp"%>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
			...
			<div class="container-login100">
				<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
					<form class="login100-form validate-form"
						action="${pageContext.request.contextPath }/account/login.do" method="POST">
						...
						<div class="wrap-input100 rs1 validate-input" data-validate="Password를 입력하세요">
						...
						<div class="text-center p-t-45 p-b-4">
							...
							<a href="#" class="txt2 hov1">UserID / Password?</a>
						</div>
	...
	<!-- account footer 선언 -->
	<%@ include file="/WEB-INF/views/account/footer.jsp"%>